...
def render_recommendation_card(rec: Dict[str, Any], index: int):
    ...
    if "fallback" in n['insight'].lower() or "FALLBACK MATCH:" in n['insight']:
    ...
    elif "RELEVANT MATCH:" in n['insight']:
        match_badge = '<span style="background: rgba(59, 130, 246, 0.1); color: #3b82f6; padding: 2px 6px; border-radius: 4px; font-size: 0.6rem; font-weight: 800; border: 1px solid rgba(59, 130, 246, 0.2);">RELEVANT MATCH</span>'
