...
class RoleNormalizer:
    ...
    ROLE_ALIASES: Dict[NormalizedRole, Dict[str, float]] = {
        ...
        NormalizedRole.FRONTEND_ENGINEER: {
            ...
            "frontend software engineer": 1.0,
            "react developer": 0.95,
            "react engineer": 0.95,
            "angular developer": 0.95,
            "angular engineer": 0.95,
            "vue developer": 0.95,
            "javascript developer": 0.90,
            "typescript developer": 0.90,
    ...
    TECH_TO_DOMAIN: Dict[str, List[NormalizedRole]] = {
        ...
        "angular": [NormalizedRole.FRONTEND_ENGINEER],
        "vue": [NormalizedRole.FRONTEND_ENGINEER],
        "nextjs": [NormalizedRole.FRONTEND_ENGINEER],
